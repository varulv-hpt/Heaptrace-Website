...
export default function HomeTestimonialsCarousel() {
  ...
  return (
    ...
    >
      <div className="relative w-full overflow-x-hidden px-12 sm:px-16 md:px-20">
        <div
          className={`testimonial-slide flex min-h-[392px] w-full flex-col items-center text-center transition-opacity ease-out`}
          style={{
