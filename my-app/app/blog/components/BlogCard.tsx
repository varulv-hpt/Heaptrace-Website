...
export default function BlogCard({ post }: BlogCardProps) {
  return (
    <article className="flex h-full flex-col rounded-2xl border border-[#dce3ea] bg-white p-6 shadow-[0_12px_28px_rgba(20,25,45,0.06)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_34px_rgba(20,25,45,0.12)]">
